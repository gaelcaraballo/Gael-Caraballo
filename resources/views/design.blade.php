            ...
            <a class="text-center" data-bs-target="#imageModal" data-bs-toggle="modal" href="#"
               onclick="showImage('public/assets/design/balenyaStFeliu.png')">
                <div class="cardHolders">
                    <img alt="First Card" class="img-fluid" loading="lazy" src="public/assets/design/balenyaStFeliu.png">
                </div>
            </a>
        </div>
        <div class="col mt-3">
            <a class="text-center" data-bs-target="#imageModal" data-bs-toggle="modal" href="#"
               onclick="showImage('public/assets/design/centellesBalenya.png')">
                <div class="cardHolders">
                    <img alt="First Card" class="img-fluid" loading="lazy" src="public/assets/design/centellesBalenya.png">
                </div>
            </a>
        </div>
        <div class="col mt-3">
